...
const HodYear3Timetable = () => {
  ...
  const filteredTimetable =
    useMemo(() => {
      if (selectedDay === "ALL") {
        return year3Timetable;
      }

      return year3Timetable.filter(
        (item) =>
          String(
            item?.day_of_week ||
              item?.day ||
      ...
      <div className="overflow-hidden rounded-2xl border bg-white shadow-sm">
        ...
        {loading ? (
          ...
          <div className="px-6 py-16 text-center text-slate-500">
            No Year 3 timetable entries found.
          </div>
...
export default HodYear3Timetable;